...
print("Categorical vaiables: ", len(object_cols))
...
models = [LogisticRegression(n_jobs=-1), XGBClassifier(n_jobs=-1),
          RandomForestClassifier(n_estimators=7, criterion='entropy', random_state=7, n_jobs=-1)]
...
for i in range(len(models)):
    ...
    print('Trainig accuracy : ', ras(y_train, train_preds))
